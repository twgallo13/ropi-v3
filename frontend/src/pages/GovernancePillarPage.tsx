...
const SURFACES = [
  ...
  { title: "Permissions Matrix", description: "Role-based access control + approval workflows.", href: "/admin/governance/permissions", status: "coming" as const, comingLabel: "Coming in B.5" },
];
