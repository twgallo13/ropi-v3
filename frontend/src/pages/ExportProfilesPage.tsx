...
export default function ExportProfilesPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      ...
      <h1 className="text-2xl font-bold mb-4">Export Profiles</h1>
      <div className="bg-white dark:bg-gray-800 border rounded-lg p-6 text-center text-gray-400">
        <p className="text-lg">Coming soon</p>
        <p className="text-sm mt-1">Export format configuration and channel-specific templates will be managed here.</p>
      </div>
    </div>
  );
}
