  ...
  await client.request({ url: `${base}/${s}`, method: "PUT", data: {
    ...
    spec: { template: {
      ...
      spec: { containerConcurrency: 80, timeoutSeconds: 300, containers: [{
        ...
        env: [{ name: "NODE_ENV", value: "development" }, { name: "FIREBASE_PROJECT_ID", value: p }, { name: "FIREBASE_STORAGE_BUCKET", value: p + "-imports" }, ...(process.env.ANTHROPIC_API_KEY ? [{ name: "ANTHROPIC_API_KEY", value: process.env.ANTHROPIC_API_KEY }] : [])],
