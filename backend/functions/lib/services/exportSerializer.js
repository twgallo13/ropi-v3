 ...
 */
async function serializeProduct(mpn) {
    ...
    const attrs = {};
    attrSnap.forEach((a) => {
        if (a.id !== "source_inputs")
            attrs[a.id] = a.data().value;
    });
    ...
    try {
        ...
        exportRicsOffer = actionSnap.docs[0]?.data().export_rics_offer
            || (0, pricingUtils_1.apply99Rounding)(p.rics_offer || 0);
    }
    catch {
    ...
    return {
        ...
        pricing: {
            ...
            cost_is_estimated: snapshot.cost_is_estimated !== undefined
...
//# sourceMappingURL=exportSerializer.js.map