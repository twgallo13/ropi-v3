...
router.post("/:mpn/ai-describe", auth_1.requireAuth, (0, roles_1.requireRole)(["admin", "completion_specialist", "operations_operator"]), async (req, res) => {
    try {
        ...
        const results = await Promise.all(site_owners.map((siteOwner) => (0, aiDescribe_1.generateContent)(mpn, siteOwner, userId, observations_note)));
        res.json({ results });
    }
    catch (err) {
...
router.get("/:mpn/content-versions", auth_1.requireAuth, (0, roles_1.requireRole)(["admin", "completion_specialist", "operations_operator"]), async (req, res) => {
    try {
        const mpn = decodeURIComponent(req.params.mpn);
        const siteOwner = req.query.site_owner;
...
router.post("/:mpn/content-versions/:version_id/approve", auth_1.requireAuth, (0, roles_1.requireRole)(["admin", "completion_specialist", "operations_operator"]), async (req, res) => {
    try {
        const mpn = decodeURIComponent(req.params.mpn);
...
router.post("/:mpn/content-versions/:version_id/reject", auth_1.requireAuth, (0, roles_1.requireRole)(["admin", "completion_specialist", "operations_operator"]), async (req, res) => {
    try {
        const mpn = decodeURIComponent(req.params.mpn);
        const { version_id } = req.params;
        const docId = (0, mpnUtils_1.mpnToDocId)(mpn);
...
router.post("/:mpn/content-versions/:version_id/edit", auth_1.requireAuth, (0, roles_1.requireRole)(["admin", "completion_specialist", "operations_operator"]), async (req, res) => {
    try {
        const mpn = decodeURIComponent(req.params.mpn);
        const { version_id } = req.params;
        const docId = (0, mpnUtils_1.mpnToDocId)(mpn);
...
router.post("/:mpn/content-versions/:version_id/restore", auth_1.requireAuth, (0, roles_1.requireRole)(["admin", "completion_specialist", "operations_operator"]), async (req, res) => {
    try {
        const mpn = decodeURIComponent(req.params.mpn);
        const { version_id } = req.params;
        const docId = (0, mpnUtils_1.mpnToDocId)(mpn);
