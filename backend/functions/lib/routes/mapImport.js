...
exports.MAP_TARGET_FIELDS = void 0;
/**
...
function buildSuggestedMapping(rawHeaders) {
    const out = {};
...
router.post("/upload", auth_1.requireAuth, (0, roles_1.requireRole)(["map_analyst"]), upload.single("file"), async (req, res) => {
    try {
        ...
        res.status(200).json({
            ...
            target_fields: exports.MAP_TARGET_FIELDS,
        });
    }
    catch (err) {
...
router.post("/:batch_id/map-columns", auth_1.requireAuth, (0, roles_1.requireRole)(["map_analyst"]), async (req, res) => {
    try {
        ...
        if (!column_mapping ||
            ...
            res.status(400).json({
                error: "column_mapping.mpn and column_mapping.map_price are required (brand / promo / dates are optional)",
            });
            return;
        }
